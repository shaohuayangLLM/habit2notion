    ...
    def render_image(self, token):
        ...
        return {
            ...
            "image": {
                "type": "external",
                "external": {
                    "url": "https://images.unsplash.com/photo-1537727365640-d9b9cbeeac34?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8MTl8fHxlbnwwfHx8fHw%3D"
                },
            },
        }
